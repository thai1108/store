export default {
  ...
  orders: {
    ...
    noOrdersText: 'Bắt đầu mua sắm để tạo đơn hàng đầu tiên!',
  ...
  admin: {
    ...
    underConstruction: 'Đang phát triển',
    ...
    orderManagement: {
      ...
      address: 'Địa chỉ',
      notes: 'Ghi chú',
      statusUpdated: 'Cập nhật trạng thái đơn hàng thành công',
      pending: 'Chờ xử lý',
      confirmed: 'Đã xác nhận',
      completed: 'Hoàn thành',
      cancelled: 'Đã hủy',
    ...
    userManagement: {
      ...
      totalAdmins: 'Tổng quản trị viên',
    },
  },
  errors: {
